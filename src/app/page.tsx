      ...
      <section className={`container section-gap`}>
        ...
        <div className={styles.productGrid}>
          <ProductCard 
            ...
            imageSrc="/hempsettlement-prev/images/daytimeMieszanka.png" 
          />
          <ProductCard 
            name="DREAM CATCHER" 
            category="Mieszanka ziołowa" 
            ...
            imageSrc="/hempsettlement-prev/images/nighttimeMieszanka.png" 
          />
          <ProductCard 
            ...
            imageSrc="/hempsettlement-prev/images/bletki.png" 
          />
        </div>
      </section>
      ...
      <section className={styles.vending}>
        <div className={`container ${styles.vendingGrid}`}>
          ...
          <div className={styles.vendingImage}>
            <Image src="/hempsettlement-prev/images/automat.png" alt="Hemp Settlement Vending Machine" width={400} height={600} style={{ objectFit: 'contain' }} />
          </div>
        </div>
      </section>
    </>
